...
AmqpRpc.prototype.makeRequest = function(queue_name, content, callback){
	//console.log("in AmqpRpc.make_request " );
  self = this;
  //generate a unique correlation id for this call
  var correlationId = crypto.randomBytes(16).toString('hex');
  
 // console.log("in AmqpRpc.make_request correlationId " +correlationId);
  
  //create a timeout for what should happen if we don't get a response
  var tId = setTimeout(function(corr_id){
	//  console.log("in AmqpRpc.setTimeout " );
...
//	console.log("in AmqpRpc.setupResponseQueue " );
  ...
  //  console.log("in AmqpRpc.self.connection.queue " +self.response_queue);
    //subscribe to messages
    q.subscribe(function(message, headers, deliveryInfo, m){
    //	console.log("in AmqpRpc.subscribe " +message);
